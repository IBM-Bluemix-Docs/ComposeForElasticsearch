...
Un service {{site.data.keyword.composeForElasticsearch_full}} démarre avec trois noeuds de données identiques, dotés chacun de 2 Go de stockage et de 204 Mo de mémoire, ce qui équivaut à 2 unités de ressources. Le service _inclut_ la réplication et la haute disponibilité, de sorte que chaque unité et le prix unitaire _incluent_ le coût des ressources dans les trois noeuds.
