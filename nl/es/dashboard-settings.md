...
# Valores
Estas características le permiten adaptar el servicio {{site.data.keyword.composeForElasticsearch_full}} para que se ajuste mejor a sus necesidades y requisitos.
...
![El panel Versión](./images/elastic_search-version-show.png "El panel Versión")
...
Aunque la entrada IP permite IPv6, actualmente no hay despliegues de Compose disponibles para redes IPv6, de modo que no se puede filtrar por estas direcciones.
{: .tip}
