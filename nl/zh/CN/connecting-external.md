...
以下示例中使用的客户机是 [Jest](https://github.com/searchbox-io/Jest)，它为您提供了一个用于 Java 的简单 HTTP REST 客户机。您可以遵循其 [Github 存储库](https://github.com/searchbox-io/Jest/tree/master/jest) 上的安装指南并查看代码示例。
